...
public class MethodOverloadingSession {
	public static void main(String[] args) {
        collegeRegister(1001);
        collegeRegister("Swathi");
        collegeRegister("Nandu", 25);
        collegeRegister(1002, "Rijesh");

        bankAccount(4523789456l);
        bankAccount("Swathi");
        bankAccount(456123, "Prajina", 23412453l);
        bankAccount("Maneesh", 30254123l, 7795668);
